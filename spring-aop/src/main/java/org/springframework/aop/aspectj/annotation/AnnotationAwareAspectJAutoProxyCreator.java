...
public class AnnotationAwareAspectJAutoProxyCreator extends AspectJAwareAdvisorAutoProxyCreator {
	...
	/**
	 * 反射切面增强工厂 ReflectiveAspectJAdvisorFactory 这个是在setBeanFactory时初始化的
	 */
	@Nullable
	...
	protected List<Advisor> findCandidateAdvisors() {
		...
		if (this.aspectJAdvisorsBuilder != null) {
			//加上解析出来的Advisor InstantiationModelAwarePointcutAdvisorImpl
	...
	protected boolean isInfrastructureClass(Class<?> beanClass) {
		...
		//是否是基础设施类  aspectJAdvisorFactory、aspectJAdvisorFactory都是在实例化当前bean的时候setBeanFactory设置的
