...
public class RootBeanDefinition extends AbstractBeanDefinition {
	...
	/**
	 * 是否进行后置处理，调用beanPostProcessor的postProcessMergedBeanDefinition方法后为true
	 */
	...
	/**
	 * 存放已注册的外部配置，@Autowired、@Value、@Resource的属性或者方法
	 */
	@Nullable
	private Set<Member> externallyManagedConfigMembers;
	/**
	 * 存放已注册的@PostConstruct的methodName
	 */
	@Nullable
	private Set<String> externallyManagedInitMethods;
	/**
	 * 存放已注册的@PreDestory的methodName
	 */
	@Nullable
