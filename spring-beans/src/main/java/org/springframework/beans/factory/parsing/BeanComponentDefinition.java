...
public class BeanComponentDefinition extends BeanDefinitionHolder implements ComponentDefinition {
	/**
	 * 内部bean的beanDefinition集合
	 */
	private BeanDefinition[] innerBeanDefinitions;
	/**
	 * ref的依赖bean的beanDefinition集合
	 */
	...
	/**
	 * 根据beanDefinitionHolder创建一个BeanComponentDefinition
	 * Create a new BeanComponentDefinition for the given bean.
	...
	public BeanComponentDefinition(BeanDefinitionHolder beanDefinitionHolder) {
		...
		//这里可以看到如果属性孩子对象是BeanDefinitionHolder或者BeanDefinition，那么这个bean就是内部bean，如果
		//是BeanReference（RuntimeBeanReference）就是依赖的bean
