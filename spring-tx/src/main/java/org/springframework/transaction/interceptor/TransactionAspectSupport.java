...
public abstract class TransactionAspectSupport implements BeanFactoryAware, InitializingBean {
	...
	protected Object invokeWithinTransaction(Method method, @Nullable Class<?> targetClass,
		...
		//获取事务属性对象 通常是RuleBasedTransactionAttribute
		final TransactionAttribute txAttr = (tas != null ? tas.getTransactionAttribute(method, targetClass) : null);
		//获取事务管理器，常用的有 DataSourceTransactionManager
	...
	protected PlatformTransactionManager determineTransactionManager(@Nullable TransactionAttribute txAttr) {
		...
		//事务管理器beanName不为空
			...
			if (defaultTransactionManager == null) {
				...
				if (defaultTransactionManager == null) {
					//如果都为空就直接从容器中获取PlatformTransactionManager的类
	 ...
	 *  @param tm 事务管理器
	 *  @param txAttr 事务属性
	 *  @param joinpointIdentification 事务名称
	 */
	protected TransactionInfo createTransactionIfNecessary(@Nullable PlatformTransactionManager tm,
			@Nullable TransactionAttribute txAttr, final String joinpointIdentification) {

		// If no name specified, apply method identification as transaction name.
		//创建一个事务属性装饰类，修改其事务名称，表示唯一标识
		...
		//将TransactionStatus包装成TransactionInfo对象
	...
	/**
	 * 将TransactionStatus包装成TransactionInfo对象
	 * @param tm 事务管理器DataSourceTransactionManager
	...
	protected final class TransactionInfo {
		...
		/**
		 * 事务属性 RuleBasedTransactionAttribute
		 */
		@Nullable
