...
public class RestTemplate extends InterceptingHttpAccessor implements RestOperations {
	...
	public <T> ResponseEntity<T> getForEntity(String url, Class<T> responseType, Map<String, ?> uriVariables)
			throws RestClientException {
		//创建一个AcceptHeaderRequestCallback回调对象
		RequestCallback requestCallback = acceptHeaderRequestCallback(responseType);
		//创建一个ResponseEntityResponseExtractor
		ResponseExtractor<ResponseEntity<T>> responseExtractor = responseEntityExtractor(responseType);
		return nonNull(execute(url, HttpMethod.GET, requestCallback, responseExtractor, uriVariables));
	}
	 ...
	 * 调用请求
	 * @param url 请求地址
	 * @param method http请求类型 (GET, POST, etc)
	 * @param requestCallback 请求回调对象
	 * @param responseExtractor 返回提取器对象
	 * @param uriVariables 请求参数对象
	 * @param <T>
	 * @return
	 * @throws RestClientException
	 */
	...
	/**
	 * 调用请求
	 * @param url  请求地址的URI对象
	 * @param method 请求方式
	 * @param requestCallback 请求回调对象
	 * @param responseExtractor 返回回调对象
	 * @param <T>
	 * @return
	 * @throws RestClientException
	 */
	...
	protected <T> T doExecute(URI url, @Nullable HttpMethod method, @Nullable RequestCallback requestCallback,
		...
		try {
			//创建ClientHttpRequest对象 SimpleBufferingClientHttpRequest
			ClientHttpRequest request = createRequest(url, method);
			if (requestCallback != null) {
				requestCallback.doWithRequest(request);
			}
			//获取返回值对象 SimpleClientHttpResponse
	...
	private class AcceptHeaderRequestCallback implements RequestCallback {
		...
		/**
		 * 回调对象
		 * @param request SimpleBufferingClientHttpRequest
		 * @throws IOException
		 */
		@Override
	...
	private class ResponseEntityResponseExtractor<T> implements ResponseExtractor<ResponseEntity<T>> {
		/**
		 * 消息转化提取器 HttpMessageConverterExtractor
		 */
		@Nullable
		private final HttpMessageConverterExtractor<T> delegate;

		/**
		 * 创建ResponseEntityResponseExtractor
		 * @param responseType
		 */
		...
		/**
		 * 提取数据
		 * @param response SimpleClientHttpResponse
		 * @return
		 * @throws IOException
		 */
		@Override
